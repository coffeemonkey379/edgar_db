...
class EdgarParser(metaclass=ABCMeta):
    orm: Type[Base]
...
class SubmissionParser(EdgarParser):
    orm = SubmissionOrm
...
class CoverPageParser(EdgarParser):
    orm = CoverPageOrm
...
class OtherManagerParser(EdgarParser):
    orm = OtherManagerOrm
...
class SignatureParser(EdgarParser):
    orm = SignatureOrm
...
class SummaryPageParser(EdgarParser):
    orm = SummaryPageOrm
...
class OtherManager2Parser(EdgarParser):
...
class InfoTableParser(EdgarParser):
    orm = InfoTableOrm
